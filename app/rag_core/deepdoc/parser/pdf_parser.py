...
from ...constants import LOCAL_MODEL_DIR, RAG_LIGHTEN_MODE, PARALLEL_DEVICES
    ...
    def __init__(self, **kwargs):
        ...
        try:
            ...
            model_dir = snapshot_download(
                ...
                local_dir=os.path.join(LOCAL_MODEL_DIR, "deepdoc"),
...
class VisionParser(RAGFlowPdfParser):
    ...
    async def __call__(self, filename, from_page=0, to_page=100000, **kwargs):
        ...
        for idx, img_binary in enumerate(self.page_images or []):
            ...
            docs = await picture_vision_llm_chunk(
                binary=img_binary,
